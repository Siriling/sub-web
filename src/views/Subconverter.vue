        ...
        remoteConfig: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: "ACL_全分组谷歌版",
                value: "https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_Online_Full_Google.ini"
              },
              {
                label: "ACL_全分组多模式版",
                value: "https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_Online_Full_MultiMode.ini"
              },
              {
                label: "ACL_全分组奈飞版",
              ...
              {
                label: "ACL_多国家精简版",
                value: "https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_Online_Mini_MultiCountry.ini"
              },
              {
                label: "ACL_多模式精简版",
          ...
          },
          {
            ...
            options: [
              {
                label: "常规规则",
                value: "https://cdn.jsdelivr.net/gh/flyhigherpi/merlinclash_clash_related@master/Rule_config/ZHANG.ini"
              },
              {
                label: "酷酷自用",
              ...
              {
                label: "分区域故障转移",
                value: "https://cdn.jsdelivr.net/gh/flyhigherpi/merlinclash_clash_related@master/Rule_config/ZHANG_Area_Fallback.ini"
              },
              {
                label: "分区域自动测速",
                value: "https://cdn.jsdelivr.net/gh/flyhigherpi/merlinclash_clash_related@master/Rule_config/ZHANG_Area_Urltest.ini"
              },
              {
                label: "分区域无自动测速",
                value: "https://cdn.jsdelivr.net/gh/flyhigherpi/merlinclash_clash_related@master/Rule_config/ZHANG_Area_NoAuto.ini"
              },
              {
                label: "OoHHHHHHH",
                value: "https://cdn.jsdelivr.net/gh/OoHHHHHHH/ini@master/config.ini"
              },
              {
                label: "CFW-TAP",
                value: "https://cdn.jsdelivr.net/gh/OoHHHHHHH/ini@master/cfw-tap.ini"
              },
              {
                label: "lhl77全分组（定期更新）",
                value: "https://cdn.jsdelivr.net/gh/lhl77/sub-ini@main/tsutsu-full.ini"
              },
              {
                label: "lhl77简易版（定期更新）",
                value: "https://cdn.jsdelivr.net/gh/lhl77/sub-ini@main/tsutsu-mini-gfw.ini"
              },
              {
              ...
              },
              {
                ...
                value: "https://cdn.jsdelivr.net/gh/Mazeorz/airports@master/Clash/Examine.ini"
              },
              {
                label: "品云专属配置（全地域分组）",
                value: "https://cdn.jsdelivr.net/gh/Mazeorz/airports@master/Clash/Examine_Full.ini"
              },
              {
                label: "nzw9314 规则",
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: "咸鱼",
                value: "https://cdn.jsdelivr.net/gh/SleepyHeeead/subconverter-config@master/remote-config/customized/xianyu.ini"
              },
              {
                label: "便利店",
              ...
              {
                label: "CNIX",
                value: "https://cdn.jsdelivr.net/gh/Mazeorz/airports@master/Clash/SSRcloud.ini"
              },
              {
                label: "Nirvana",
                value: "https://cdn.jsdelivr.net/gh/Mazetsz/ACL4SSR@master/Clash/config/V2rayPro.ini"
              },
              {
                label: "V2Pro",
                value: "https://cdn.jsdelivr.net/gh/Mazeorz/airports@master/Clash/V2Pro.ini"
              },
              {
                label: "史迪仔-自动测速",
                value: "https://cdn.jsdelivr.net/gh/Mazeorz/airports@master/Clash/Stitch.ini"
              },
              {
                label: "史迪仔-负载均衡",
                value: "https://cdn.jsdelivr.net/gh/Mazeorz/airports@master/Clash/Stitch-Balance.ini"
              },
              {
                label: "Maying",
